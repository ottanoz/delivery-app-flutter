...
class _MyAppState extends State<MyApp> {
  ...
  void _changeThemeColor() {
    setState(() {
      ...
      if (_themeColor == Colors.green) {
        _themeColor = Colors.blue;
      } else if (_themeColor == Colors.blue) {
        _themeColor = Colors.purple;
      } else if (_themeColor == Colors.purple) {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(
        title: 'Bem vindo',
        onChangeTheme: _changeThemeColor,
...
class MyHomePage extends StatefulWidget {
  const MyHomePage({super.key, required this.title, required this.onChangeTheme, required this.themeColor});
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: widget.themeColor.shade100,
